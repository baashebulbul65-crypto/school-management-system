...
const FILTERS = [
  ...
  { id: 'unread', label: 'Aan La Akhrin' },
  { id: 'fee', label: 'Lacagta' },
  { id: 'attendance', label: 'Imaanshaha' },
  { id: 'exam', label: 'Imtixaanada' },
  { id: 'message', label: 'Fariimaha' },
  { id: 'system', label: 'Nidaamka' },
];

const TYPE_META = {
  fee: { color: 'orange', label: 'Lacagta', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>) },
  attendance: { color: 'red', label: 'Imaanshaha', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 12l2 2 4-4M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z"/></svg>) },
  exam: { color: 'purple', label: 'Imtixaanada', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 10L12 5 2 10l10 5 10-5zM6 12v5c0 1.5 3 3 6 3s6-1.5 6-3v-5"/></svg>) },
  message: { color: 'blue', label: 'Fariinta', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>) },
  system: { color: 'navy', label: 'Nidaamka', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06A1.65 1.65 0 004.6 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06A1.65 1.65 0 009 4.6a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09A1.65 1.65 0 0015 4.6a1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>) },
};
    ...
    <div>
      <div className="page-header">
        <div className="page-header-text">
          <h2>Ogeysiisyada</h2>
          <p>La soco dhammaan dhacdooyinka muhiimka ah ee nidaamka.</p>
        </div>
        {unreadCount > 0 && (
          <button className="btn-secondary" onClick={markAllAsRead}>
            ...
            Calaamadee Dhammaan ({unreadCount})
          </button>
        )}
      </div>
        ...
        <div className="notif-full-list">
          {filtered.length === 0 && (
            <div className="notif-empty">
              ...
              <p>Ogeysiis lama helin qaybtan.</p>
            </div>
          )}
          ...
          {filtered.map((n) => {
            ...
            return (
              <div key={n.id} className={`notif-full-item ${!n.read ? 'unread' : ''}`}>
                <button className="notif-full-main" onClick={() => handleItemClick(n)}>
                  ...
                  <div className="notif-full-body">
                    <div className="notif-full-top">
                      ...
                      <span className={`badge-tag ${meta.color}`}>{meta.label}</span>
                    </div>
                ...
                <button className="notif-delete-btn" title="Tirtir" onClick={() => deleteNotification(n.id)}>
