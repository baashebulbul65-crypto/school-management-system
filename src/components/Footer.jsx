    ...
    <footer className="footer" id="contact">
      <div className="footer-top">
        <div className="footer-brand">
          <div className="footer-logo">
            <svg viewBox="0 0 40 40" fill="none">
              ...
              <circle cx="30" cy="8" r="3" style={{ fill: 'var(--mint)' }}/>
              <path d="M8 30 H24" style={{ stroke: '#fff' }} strokeWidth="4" strokeLinecap="round"/>
            </svg>
          ...
          <div className="footer-social">
            <a href="#" aria-label="Facebook" onClick={notReady}>
            ...
            <a href="#" aria-label="WhatsApp" onClick={notReady}>
            ...
            <a href="#" aria-label="YouTube" onClick={notReady}>
        ...
        <div className="footer-links">
          <h4>Nidaamka</h4>
          <ul>
            <li><a href="#about">Waxa Uu Ku Sarreeyo</a></li>
            <li><a href="#how-it-works">Sida Uu U Shaqeeyo</a></li>
            <li><a href="#pricing">Qiimaha</a></li>
            <li><a href="#faq">Su&apos;aalaha Guud</a></li>
          </ul>
        </div>
        ...
        <div className="footer-links">
          <h4>Shirkadda</h4>
          <ul>
            <li><a href="#about">Nagu Saabsan</a></li>
            <li><a href="#contact">Xiriirka</a></li>
            <li><a href="#" onClick={notReady}>Blog-ga</a></li>
            <li><a href="#" onClick={notReady}>Shaqooyinka</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-legal">
          <a href="#" onClick={notReady}>Sharciga Asturnaanta</a>
          <a href="#" onClick={notReady}>Shuruudaha Adeegga</a>
        </div>
      </div>
    </footer>
  );
